...
function removeGenerator(tree, schema) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const project = devkit_1.readProjectConfiguration(tree, schema.projectName);
        check_dependencies_1.checkDependencies(tree, schema);
        check_targets_1.checkTargets(tree, schema);
        update_jest_config_1.updateJestConfig(tree, schema, project);
        remove_project_1.removeProject(tree, project);
        remove_project_config_1.removeProjectConfig(tree, schema);
        update_tsconfig_1.updateTsconfig(tree, schema, project);
...
exports.removeSchematic = devkit_1.convertNxGenerator(removeGenerator);
