...
const getBaseKarmaConfig = require('${devkit_1.offsetFromRoot(projectRoot)}karma.conf');
...
module.exports = function(config) {
  ...
  config.set({
    ...
    coverageIstanbulReporter: {
      ...
      dir: join(__dirname, '${devkit_1.offsetFromRoot(projectRoot)}coverage/${projectRoot}')
    }
  });
};
`);
