...
function renameNpmPackages(packageRenameMapping) {
    return (tree, context) => {
        const pkg = ast_utils_1.readJsonInTree(tree, 'package.json');
        ...
        return schematics_1.chain([
            ...
            rename_package_imports_1.renamePackageImports(packageNameMapping),
            // add the new name at either the old version or a new version
            ast_utils_1.addDepsToPackageJson(depAdditions, devDepAdditions),
