...
function update() {
    return () => {
        if (process.argv[2] === 'update') {
            ...
            console.log('-------------------------------------------------------------');
            console.log('-------------------------------------------------------------');
            throw new Error(`Use "nx migrate" instead of "ng update". Read more at: Read more at: https://nx.dev/latest/angular/workspace/update`);
        }
    };
}
exports.default = update;
//# sourceMappingURL=update-command-check.js.map