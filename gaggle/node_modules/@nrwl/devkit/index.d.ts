...
export { WorkspaceJsonConfiguration, TargetConfiguration, ProjectConfiguration, ProjectType, Generator, GeneratorCallback, Executor, ExecutorContext, } from '@nrwl/tao/src/shared/workspace';
...
export { WorkspaceConfiguration, addProjectConfiguration, readProjectConfiguration, removeProjectConfiguration, updateProjectConfiguration, readWorkspaceConfiguration, updateWorkspaceConfiguration, getProjects, } from './src/generators/project-configuration';
