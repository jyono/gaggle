...
function updateRootESLintConfig(host) {
    return host.exists('.eslintrc.json')
        ? workspace_1.updateJsonInTree('.eslintrc.json', (json) => {
...
function updateReactESLintConfigs(host) {
    ...
    return schematics_1.chain([
        ...Object.keys(workspace.projects).map((k) => {
            ...
            const eslintConfigPath = core_1.join(core_1.normalize(p.root), '.eslintrc.json');
            if (!host.exists(eslintConfigPath)) {
                return schematics_1.noop();
            }
            return workspace_1.updateJsonInTree(eslintConfigPath, (json) => {
                var _a, _b, _c;
                /**
                 ...
                 */
                if (((_a = json.plugins) === null || _a === void 0 ? void 0 : _a.includes('react')) || ((_b = json.plugins) === null || _b === void 0 ? void 0 : _b.includes('react-hooks')) || ((_c = json.plugins) === null || _c === void 0 ? void 0 : _c.includes('jsx-a11y'))) {
