...
// testing-fetch-start
function createFetcher(packageManager) {
    const cache = {};
...
function generateMigrationsJsonAndUpdatePackageJson(root, opts) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const packageManager = package_manager_1.detectPackageManager();
        const pmc = package_manager_1.getPackageManagerCommand(packageManager);
        try {
...
function installAngularDevkitIfNecessaryToExecuteLegacyMigrations(migrations) {
    ...
    if (!hasAngularDevkitMigrations)
        return false;
    const pmCommands = package_manager_1.getPackageManagerCommand(package_manager_1.detectPackageManager());
...
function runMigrations(root, opts, isVerbose) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const migrations = JSON.parse(stripJsonComments(fs_1.readFileSync(path_1.join(root, opts.runMigrations)).toString())).migrations;
...
function removeNxDepsIfCaseItsFormatChanged(root) {
    try {
        fsExtra.unlinkSync(path_1.join(root, 'node_modules', '.cache', 'nx', 'nxdeps.json'));
    }
    catch (e) { }
}
