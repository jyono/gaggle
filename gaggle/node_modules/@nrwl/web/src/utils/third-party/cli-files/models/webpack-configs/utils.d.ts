...
export declare function getSourceMapDevTool(scriptsSourceMap: boolean, stylesSourceMap: boolean, hiddenSourceMap?: boolean, vendorSourceMap?: boolean): SourceMapDevToolPlugin;
/**
