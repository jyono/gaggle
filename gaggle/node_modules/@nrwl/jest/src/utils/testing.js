...
const testRunner = new testing_1.SchematicTestRunner('@nrwl/jest', path_1.join(__dirname, '../../collection.json'));
const migrationTestRunner = new testing_1.SchematicTestRunner('@nrwl/jest/migrations', path_1.join(__dirname, '../../migrations.json'));
